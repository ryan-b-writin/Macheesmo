...
{	
	...
	[RequireComponent(typeof(CheesyHealth))]
	...
	public class CheesyStompable : MonoBehaviour 
	{
	    ...
	    protected CheesyHealth _health;
	    ...
	    protected virtual void Start ()
	    {
            ...
            _health = this.gameObject.GetComponent<CheesyHealth>();	
