...
namespace MoreMountains.CorgiEngine
{
    ...
    public class SurfaceCrawler : MonoBehaviour
    {
        ...
        protected virtual void DetermineDirection()
        {
            ...
            RaycastHit2D forwardHit = MMDebug.RayCast(_raycastOrigin + ForwardRaycastOffset, _forwardRaycastDirection, ForwardRaycastLength, SurfaceLayerMask, Color.black, DrawGizmos);
            ...
            else
            {
                ...
                RaycastHit2D downwardHit = MMDebug.RayCast(_raycastOrigin + DownwardRaycastOffset, -_rotationReference.up, DownwardRaycastLength, SurfaceLayerMask, Color.blue, DrawGizmos);
                if (downwardHit)
                {
                ...
                else
                {
                    ...
                    {
                        downwardHit = MMDebug.RayCast(_raycastOrigin + DownwardRaycastOffset, -_rotationReference.up, DownwardRaycastLength, SurfaceLayerMask, Color.red, DrawGizmos);
            ...
            MMDebug.DebugDrawArrow(this.transform.position, _movementDirection, Color.cyan, 1f, 35f);
        }
        ...
        protected virtual void RegisterHit(RaycastHit2D hit, Vector2 offset)
        {
            ...
            this.transform.position = hit.point + hit.normal * DistanceToSurface - offset;
