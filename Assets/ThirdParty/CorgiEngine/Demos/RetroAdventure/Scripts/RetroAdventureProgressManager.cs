...
{	
	...
	/// </summary>
	public class RetroAdventureProgressManager : MMPersistentSingleton<RetroAdventureProgressManager>, MMEventListener<CorgiEngineStarEvent>, MMEventListener<CorgiEngineEvent>
	{
