...
{	
	...
	/// </summary>
	public class CheesyLevelMapCharacter : MonoBehaviour//, MMEventListener<MMStateChangeEvent<>>
	{
		...
		public CheesyLevelMapPathElement StartingPoint;
		...
		public CheesyLevelMapPathElement LastVisitedPathElement { get; set; }

		protected CheesyLevelMapPathElement _destination;
		...
		protected CheesyLevelMapPathElement _currentPathElement;
		...
		public virtual void SetCurrentPathElement(CheesyLevelMapPathElement pathElement)
		{
		...
		public virtual void SetDestination(CheesyLevelMapPathElement newDestination)
		{
